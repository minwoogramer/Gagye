  ...
  return (
    <Container>
      ...
      <Desc>
        ...
        represents you and can also make you know yourself better. Authenticated
        by web3 technology, these 3D models are specially crafted by leading
        experienced architects and interior designers. These 3D models can be a
        great addition to your digital collection. These assets can be
        collected, traded, or used across in multiple metaverse ecosystems and
        even more, can be built in the real world.{" "}
      </Desc>
    </Container>
  );
};
