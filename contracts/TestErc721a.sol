...
/// @title testERC721A Contract

contract testERC721AContract is
    ERC721A,
    IERC2981,
    Ownable,
    Pausable,
    ReentrancyGuard
{
    ...
    /// @dev === CONTRACT META ===
    string public contractURIstr = "ipfs://QmNN8ge8RLirgwx2uQsuuUGmnCdcozVexJc3exF1dj8y2d";
    string public baseExtension = ".json";
    string public notRevealedUri = "ipfs://QmNN8ge8RLirgwx2uQsuuUGmnCdcozVexJc3exF1dj8y2d";
